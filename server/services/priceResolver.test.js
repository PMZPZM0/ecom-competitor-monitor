...
test("authoritative selection never lets SSR hide ambiguous account promotion evidence", () => {
  ...
  assert.deepEqual(selectAuthoritativePriceResolution(unavailable, embedded, { governmentProgramObserved: true }), {
    ...unavailable,
    matched: true,
    status: "ambiguous",
